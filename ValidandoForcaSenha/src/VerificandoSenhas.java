...
public class VerificandoSenhas {
    ...
    public static String verificarForcaSenha(String senha) {
        ...
        if(senha.length() < comprimentoMinimo){
            msg = "Sua senha e muito curta. Recomenda-se no minimo 8 caracteres.";
        }else if(temLetraMaiuscula == true && temLetraMinuscula == true && temNumero == true && temCaractereEspecial == true){
            msg = "Sua senha atende aos requisitos de seguranca. Parabens!";
        }else{
            msg = "Sua senha nao atende aos requisitos de seguranca.";
        }
